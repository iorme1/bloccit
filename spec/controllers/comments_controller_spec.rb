   ...
   context "guest" do
     describe "POST create" do
       it "redirects the user to the sign in view" do
         post :create, post_id: my_post.id, comment: {body: Faker::Lorem.paragraph}
   ...
   context "member user doing CRUD on a comment they don't own" do
     ...
     describe "POST create" do
       it "increases the number of comments by 1" do
         expect{ post :create, post_id: my_post.id, comment: {body: Faker::Lorem.sentence} }.to change(Comment,:count).by(1)
       end

       it "redirects to the post show view" do
         post :create, post_id: my_post.id, comment: {body: Faker::Lorem.sentence}
