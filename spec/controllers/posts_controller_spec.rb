...
RSpec.describe PostsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "POST create" do
      it "returns http redirect" do
        post :create, topic_id: my_topic.id, post: {title: Faker::Lorem.sentence, body: Faker::Lorem.paragraph}
        expect(response).to redirect_to(new_session_path)
      end
    end
  ...
  context "member user doing CRUD on a post they don't own" do
    ...
    describe "POST create" do
      it "increases the number of Post by 1" do
        expect{ post :create, topic_id: my_topic.id, post: {title: Faker::Lorem.sentence, body: Faker::Lorem.paragraph} }.to change(Post,:count).by(1)
      end
