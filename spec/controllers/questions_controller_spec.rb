...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Questions by 1" do
      expect{post :create, question: {title: "My Title", body: "My Body", resolved: false}}.to change(Question,:count).by(1)
    end

    it "assigns new question to @question" do
      post :create, question: {title: "My Title", body: "My Body", resolved: false}
